call plug#begin()
  ...
  Plug 'stefandtw/quickfix-reflector.vim'  " Quickfix extension
  """ COMPLETION """ 
  Plug 'shougo/neco-vim' "Vimscript completion
  Plug 'eluum/vim-autopair' " Completing autopairs
